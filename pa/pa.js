function roundNumber(num, scale) {
  ...
  try {
   ...
   var ladob = document.getElementById("resposta").value = roundNumber(ladob, 2);
	  ...
	  var areaRetangulo = ladoa * ladob;
		  document.getElementById('resposta').innerHTML = "<hr> <div style='line-height: 25px;'>  A área do retângulo é: <br>    A = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>b</a1>  = "+ladoa +" ∙ "+ladob +" <br>  A = <a1 style='color: #FF0000'> "+areaRetangulo +"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'> u² </a1> </div> <hr><h1 class='logomarca'> BpW </h1>";
  ...
  try {
   ...
   var anguloα = document.getElementById("resposta").value = roundNumber(anguloα, 2); 
		  ...
		  document.getElementById('resposta').innerHTML = "<hr> O ângulo α é: <br> <div style='line-height: 25px;'> α = 180º − β = 180º − "+anguloβ+"º <br> α = <a1 style='color: #FF0000'> "+anguloα+"º  </div><hr><h1 class='logomarca'> BpW </h1>" ;
  ...
  try {
   ...
   var anguloβ = document.getElementById("resposta").value = roundNumber(anguloβ, 2);	
		  ...
		  document.getElementById('resposta').innerHTML = "<hr> O ângulo β é: <br> <div style='line-height: 25px;'>  β = 180º − α = 180º − "+anguloα+"º <br> β = <a1 style='color: #FF0000'> "+anguloβ+"º  </div><hr><h1 class='logomarca'> BpW </h1>" ;
  ...
  try {
   ...
   var areatrian_isosc2 = document.getElementById("resposta").value = roundNumber(areatrian_isosc2, 2);	
	  ...
	  document.getElementById('resposta').innerHTML = "<hr>  A área do triângulo isósceles é: <br> <div style='line-height: 24px;'> A = <a1 style='font-family: times new roman; font-style:italic;'>h</a1> ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '><a1 style='font-family: times new roman; font-style:italic;'>a</a1><a1 style='font-size: 20px; font-family: times new roman;'>² </a1> − <a1 style='font-family: times new roman; font-style:italic;'>h</a1><a1 style='font-size: 20px; font-family: times new roman;'>² </a1>  </a1> <br> A = "+altura+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+lado+"<a1 style='font-size: 20px; font-family: times new roman;'>²</a1> − "+altura+"<a1 style='font-size: 20px; font-family: times new roman;'>² </a1> </a1> <br> A = "+altura+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+lado1+" − "+altura1+"</a1> <br> A = "+altura+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+areatrian_isosc1+" </a1> <br> A = "+altura+" ∙ "+areatrian_isosc2+"  <br> A =   <a1 style='color: #FF0000'> "+areatrian_isosc+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'> u² </a1> <br>  </div><hr><h1 class='logomarca'> BpW </h1>";
  ...
  try {
   ...
   var lado1 = document.getElementById("resposta").value = roundNumber(lado1, 2); 
	  ...
	  document.getElementById('resposta').innerHTML = "<hr>  O perímetro do triângulo isósceles é: <br> <div style='line-height: 22px;'> P = <a1 style='font-family: times new roman; font-style:italic;'>b</a1> + 2∙<a1 style='font-family: times new roman; font-style:italic;'>a</a1> <br> P = "+base+" + 2 ∙ "+lado+" <br> P =  "+base+" + "+lado1+" <br> P =  <a1 style='color: #FF0000'> "+perimetro1+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1> <br>  </div><hr><h1 class='logomarca'> BpW </h1>";
  ...
  try {
   ...
   var perim6 = document.getElementById("resposta").value = roundNumber(perim6, 2); 
	  ...
	  document.getElementById('resposta').innerHTML = "<hr>  O perímetro do triângulo isósceles é: <br> <div style='line-height: 24px;'> P = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>4∙<a1 style='font-family: times new roman; font-style:italic;'>h</a1><a1 style='font-size: 20px; font-family: times new roman;'>²</a1> + <a1 style='font-family: times new roman; font-style:italic;'>b</a1><a1 style='font-size: 20px; font-family: times new roman;'>²</a1> </a1>+ <a1 style='font-family: times new roman; font-style:italic;'>b</a1> <br> P = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>4∙("+altura+")<a1 style='font-size: 20px; font-family: times new roman;'>²</a1> + "+base+"<a1 style='font-size: 20px; font-family: times new roman;'>²</a1> </a1>+ "+base+"  <br> P = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>4∙("+perim2+") + "+perim3+" </a1>+ "+base+" <br> P = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+perim4+" + "+perim3+" </a1>+ "+base+" <br> P = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+perim5+" </a1> + "+base+" <br> P = "+perim6+" </a1> + "+base+" <br> P =   <a1 style='color: #FF0000'> "+perimetro2+" "+"&nbsp</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1> <br>  </div><hr><h1 class='logomarca'> BpW </h1>";
  ...
  try {
   ...
   var lado4 = document.getElementById("resposta").value = roundNumber(lado4, 2);	 
	  ...
	  document.getElementById('resposta').innerHTML = "<hr>  O lado do triângulo isósceles é: <br> <div style='line-height: 25px;'> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '><a1 style='font-family: times new roman; font-style:italic;'>h</a1><a1 style='font-size: 20px; font-family: times new roman;'>²</a1> + <a1 style='font-family: times new roman; font-style:italic;'>b</a1><a1 style='font-size: 20px; font-family: times new roman;'>²</a1>/4 </a1> <br>   <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+altura+"<a1 style='font-size: 20px; font-family: times new roman;'>²</a1>+ ("+base+")<a1 style='font-size: 20px; font-family: times new roman;'>²</a1>/4 </a1>  <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+lado1+" + ("+lado2+")/4 </a1>&nbsp <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+lado1+" + "+lado3+"</a1> <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px; '>"+lado4+" </a1>&nbsp <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> =  <a1 style='color: #FF0000'> "+lado+" " +"&nbsp;</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1> <br> </div><hr><h1 class='logomarca'> BpW </h1>";
  ...
  try {
   ...
   var perimetro = document.getElementById("resposta").value = roundNumber(perimetro, 2);
	  ...
	  document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 23px;'>O perímetro do triângulo retângulo ABC é: <br> P = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> + <a1 style='font-family: times new roman; font-style:italic;'>b</a1> + <a1 style='font-family: times new roman; font-style:italic;'>c</a1> <br> P =  "+ladoa+"  + "+ladob+" + "+ladoc+" <br> P =  <a1 style='color: #FF0000'> "+perimetro +"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>    </div><hr><h1 class='logomarca'> BpW </h1>";
  ...
  function triangulo_equilatero1() {
   ...
   var perim1 = document.getElementById("resposta").value = roundNumber(perim1, 2);	
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 18px;'>O perímetro do triângulo equilátero ABC é: <br> P = 3 ∙ L <br> P =  3 ∙ "+ladoa+" <br> P =  <a1 style='color: #FF0000'> "+perim1+"</a1> "+" <a1 style='font-size: 17px; font-family: times new roman;font-style:italic;'>u </a1>  <hr><h1 class='logomarca'> BpW </h1> </div> ";
   ...
   var altura3 = document.getElementById("resposta").value = roundNumber(altura3, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML = "<hr>  A altura do triângulo equilátero ABC é: <br>  <div style='line-height: 14px;'> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'>  R &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'> L ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'> "+ladoa+" ∙ 1,73 </td></tr> <tr> <td> 3 </td><td> 3 </td> </tr></tbody></table> </div> R = <a1 style='color: #FF0000'> "+raio_maior+"</a1> "+" <a1 style='font-size: 17px; font-family: times new roman;font-style:italic;'>u </a1> <br> ou <br>  <div style='line-height: 14px;'>  <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'>  R &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'> L ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'> "+ladoa+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> </td></tr> <tr> <td> 3 </td><td> 3 </td> </tr></tbody></table> </div> R =  <a1 style='color: #FF0000'> "+altura3+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> "+" </a1><a1 style='font-size: 17px; font-family: times new roman;font-style:italic;'>u </a1> <hr><h1 class='logomarca'> BpW </h1>";
   ...
   var raio1 = document.getElementById("resposta").value = roundNumber(raio1, 2);
	 ...
	 document.getElementById('resposta').innerHTML = "<hr>  O lado do triângulo equilátero ABC é:  <br> <div style='line-height: 25px;'>   L = <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>h</a1> ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> = "+raio_maior+" ∙ 1,73 =&nbsp; <a1 style='color: #FF0000'> "+raio1+" </a1><a1 style='font-size: 17px; font-family: times new roman;'>u </a1>   <br> ou <br>  L = <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>h</a1> ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> = "+raio_maior+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> =&nbsp; <a1 style='color: #FF0000'> "+raio_maior+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1></a1>   <a1 style='font-size: 17px; font-family: times new roman;font-style:italic;'>u </a1>   </div> <hr><h1 class='logomarca'> BpW </h1>";
   ...
   var raio2 = document.getElementById("resposta").value = roundNumber(raio2, 2);  
	 ...
	 document.getElementById('resposta').innerHTML = "<hr> O lado do triângulo equilátero ABC é:   <br> <div style='line-height: 20px;'> L = 2 ∙ <a1 style='font-family: times new roman; font-style:italic;'>r</a1> ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> = 2 ∙ "+raio_menor+" ∙ 1,73 =&nbsp; <a1 style='color: #FF0000'> "+raio1+" </a1><a1 style='font-size: 17px; font-family: times new roman;'>u </a1>   <br> ou <br>  L = 2 ∙ r ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> = 2 ∙ "+raio_menor+" ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> =&nbsp; <a1 style='color: #FF0000'> "+raio2+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1></a1>   <a1 style='font-size: 17px; font-family: times new roman;font-style:italic;'>u </a1>     </div> <hr><h1 class='logomarca'> BpW </h1>";
  ...
  function Paralelogramo1() {
   ...
   var areaParalelogramo = document.getElementById("resposta").value = roundNumber(areaParalelogramo, 2);  
	 ...
	 document.getElementById('resposta').innerHTML = "<hr> <div style='line-height: 23px;'>A área do paralelogramo é: <br> A = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1><a1 style='font-size: 10px; font-family: times new roman; font-style:italic;'>a</a1> = "+ladoa+" ∙ "+alturaa+" <br>  A &nbsp;= <a1 style='color: #FF0000'> "+areaParalelogramo+"&nbsp; </a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'> u² </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
   ...
   var areaParalelogramo1 = document.getElementById("resposta").value = roundNumber(areaParalelogramo1, 2);   
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 23px;'>A área do paralelogramo é: <br> A = <a1 style='font-family: times new roman; font-style:italic;'>b</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1><a1 style='font-size: 10px; font-family: times new roman; font-style:italic;'>b</a1> = "+ladob+" ∙ "+alturab+" <br>  A &nbsp;= <a1 style='color: #FF0000'> "+areaParalelogramo1+"&nbsp; </a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'> u² </a1>  </div> <hr><h1 class='logomarca'> BpW </h1>";
   ...
   var perimetro2 = document.getElementById("resposta").value = roundNumber(perimetro2, 2);     
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 23px;'>O perímetro do paralelogramo é: <br> P = 2(<a1 style='font-family: times new roman; font-style:italic;'>a</a1> + <a1 style='font-family: times new roman; font-style:italic;'>b</a1>) = 2 ∙ ("+ladoa+" + "+ladob+") <br>  P &nbsp;=  2 ∙ "+perimetro2+" <br> P = <a1 style='color: #FF0000'> "+perimetro+"&nbsp;</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>  </div> <hr><h1 class='logomarca'> BpW </h1>";
   ...
   var angulo3 = document.getElementById("resposta").value = roundNumber(angulo3, 3); 	
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo  α<sub>1</sub> do paralelogramo é: <br> α<sub>1</sub> = 180° - α<sub>2</sub> =  180° - "+angulo2+"° <br> α<sub>1</sub> =  <a1 style='color: #FF0000'>"+angulo3+"</a1><a1 style='font-size: 13px; font-family: times new roman;'>° </a1>    </div> <hr><h1 class='logomarca'> BpW </h1>";
   ...
   var angulo3 = document.getElementById("resposta").value = roundNumber(angulo3, 2);   
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo  α<sub>2</sub> do paralelogramo é: <br> α<sub>2</sub> = 180° - α<sub>1</sub> =  180° - "+angulo1+"° <br> α<sub>2</sub> =  <a1 style='color: #FF0000'>"+angulo3+"</a1><a1 style='font-size: 13px; font-family: times new roman;'>° </a1>  </div> <hr><h1 class='logomarca'> BpW </h1>";
  ...
  function losango1() {
   ...
   var areaLosango = document.getElementById("resposta").value = roundNumber(areaLosango, 2);   
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 22px;'>A área do losango é: <br> A = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> = "+ladoa+" ∙ "+altura+"  <br> A =  <a1 style='color: #FF0000'> "+areaLosango+"&nbsp; </a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'> u² </a1>     </div><hr><h1 class='logomarca'> BpW </h1> ";
   ...
   try {
	...
	var perimetroLosango = document.getElementById("resposta").value = roundNumber(perimetroLosango, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 22px;'>O perímetro do losango é: <br> P = 4 ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = 4 ∙ "+ladoa+" <br> P = <a1 style='color: #FF0000'> "+perimetroLosango+"&nbsp; </a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
   ...
   try {
	...
	var ladoaLosango6 = document.getElementById("resposta").value = roundNumber(ladoaLosango6, 3);     
	 ...
	 document.getElementById('resposta').innerHTML = "<hr> O lado <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do losango é: <br> <div style='line-height: 25px;'>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>(<a1 style='font-family: times new roman; font-style:italic;'>d</a1><a1 style='font-size: 10px; font-family: times new roman;'>1</a1>/2)² + <a1 style='width:100%; height:100%; border-top:solid 1.1px;'>(<a1 style='font-family: times new roman; font-style:italic;'>d</a1><a1 style='font-size: 10px; font-family: times new roman;'>2</a1>/2)²</a1></a1> <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>("+diagonald1+"/2)² + <a1 style='width:100%; height:100%; border-top:solid 1.1px;'>("+diagonald2+"/2)²</a1></a1>  <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>("+ladoaLosango2+")² + <a1 style='width:100%; height:100%; border-top:solid 1.1px;'>("+ladoaLosango3+")²</a1></a1> <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+ladoaLosango4+" + <a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+ladoaLosango5+"</a1></a1> <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+ladoaLosango6+" </a1></a1> <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'> "+ladoaLosango+"&nbsp; </a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /** *****************************************************   ângulo: (α = 180° - β)  ****************************************  **/  
   ...
   try {
	...
	var anguloα = document.getElementById("resposta").value = roundNumber(anguloα, 3);   
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 22px;'>O ângulo α do losango é: <br> α = 180° −  β =  180° − "+anguloβ+"° <br> α = <a1 style='color: #FF0000'>"+anguloα+"° </a1> </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /*******************************************************   ângulo β: (β = 180° - α)  ****************************************  **/  
   ...
   try {
	...
	var anguloβ = document.getElementById("resposta").value = roundNumber(anguloβ, 3); 
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 22px;'>O ângulo β do losango é: <br> β = 180° −  α =  180° − "+anguloα+"° <br> β = <a1 style='color: #FF0000'>"+anguloβ+"° </a1> </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  function poligonoRegular1() {
   ...
   var perimetro = document.getElementById("resposta").value = roundNumber(perimetro, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>O perímetro do polígono regular de <a1 style='color: #FF0000'>"+ladosn+"</a1> lados é: <br> P = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>n</a1> = "+ladoa+" ∙ "+ladosn+" <br> P = <a1 style='color: #FF0000'> "+perimetro+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var ladoa4 = document.getElementById("resposta").value = roundNumber(ladoa4, 3);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  O lado <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do polígono regular  é: <br> <div style='line-height: 24px;'><a1 style='font-family: times new roman; font-style:italic;'> a </a1> = 2 ∙ R ∙ sen(180°/<a1 style='font-family: times new roman; font-style:italic;'>n</a1>) <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = 2 ∙ "+raio_maior+" ∙ sen(180°/"+ladosn+") <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = "+ladoa3+" ∙ sen("+ladoa2+"°) <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = "+ladoa3+" ∙ "+ladoa4+" <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'> "+ladoa+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var ladoa4 = document.getElementById("resposta").value = roundNumber(ladoa4, 3);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> O lado <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do polígono regular  é: <br> <div style='line-height: 24px;'> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = 2 ∙ <a1 style='font-family: times new roman; font-style:italic;'>r</a1> ∙ tg(180°/<a1 style='font-family: times new roman; font-style:italic;'>n</a1>) <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = 2 ∙ "+raio_menor+" ∙ tg(180°/"+ladosn+") <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = "+ladoa3+" ∙ tg("+ladoa2+"°) <br> <a1 style='font-family: times new roman; font-style:italic;'> a </a1> = "+ladoa3+" ∙ "+ladoa4+" <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'> "+ladoa+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ********************************   Soma dos ângulos internos: S= (n - 2).180   ************************************  **/  
   ...
   var somaangulos2 = document.getElementById("resposta").value = roundNumber(somaangulos2, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 22px;'> A soma dos ângulos internos de um polígono convexo é: <br>  S<a1 style='font-size: 10px; font-family: times new roman;'>i</a1> = (<a1 style='font-family: times new roman; font-style:italic;'>n</a1> − 2) ∙ 180°  <br>  S<a1 style='font-size: 10px; font-family: times new roman;'>i</a1> =  ("+ladosn+" − 2) ∙ 180°  <br>  S<a1 style='font-size: 10px; font-family: times new roman;'>i</a1> = "+ladosn+" ∙ 180° <br>  S<a1 style='font-size: 10px; font-family: times new roman;'>i</a1> =  <a1 style='color: #FF0000'> "+somaangulos+"</a1>"+"<a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>°</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  function circular1() {
   ...
   var areacircular2 = document.getElementById("resposta").value = roundNumber(areacircular2, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A área do círculo é: <br> <div style='line-height: 22px;'>  A = π ∙ R² = 3,14 ∙ ("+raio_maior+")²  <br>  A = 3,14 ∙ "+areacircular1+" <br> A = <a1 style='color: #FF0000'> "+areacircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br> ou <br>  A = <a1 style='color: #FF0000'> "+areacircular2+" π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var perimetrocircular1 = document.getElementById("resposta").value = roundNumber(perimetrocircular1, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 20px;'>O perímetro da circunferência é: <br>  P = 2 ∙ π ∙ R = 2 ∙ 3,14 ∙ "+raio_maior+" <br>  P = <a1 style='color: #FF0000'> "+perimetrocircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  <br> ou <br>  P = <a1 style='color: #FF0000'> "+perimetrocircular1+" π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var diametrocircular = document.getElementById("resposta").value = roundNumber(diametrocircular, 2);	
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 20px;'>O diâmetro da circunferência é: <br>  D = 2 ∙ R = 2 ∙ "+raio_maior+" <br>  D = <a1 style='color: #FF0000'> "+diametrocircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>   </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** **************************  Área do setor circular (A = (R.L)/2   ******************************************  **/  
   ...
   var setorCircular = document.getElementById("resposta").value = roundNumber(setorCircular, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A área do setor circular é: <br> <div style='line-height: 15px;'> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'>A &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'>R ∙ L </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'>"+raio_maior+" ∙ "+arcoL+"</td></tr> <tr> <td>2</td><td>2</td> </tr></tbody></table> </div> A = <a1 style='color: #FF0000'> "+setorCircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>²  <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  /** ************************ Perímetro do setor circular (P =(PI.R.α)/180°   ************************************  **/  
   ...
   var arcoLCircular1 = document.getElementById("resposta").value = roundNumber(arcoLCircular1, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 15px;'> O perímetro do setor circular é: <br>  <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'>L &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'>π ∙ R ∙ α </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'>3,14 ∙ "+raio_maior+" ∙ "+anguloα+"</td></tr> <tr> <td>180</td><td>180</td> </tr></tbody></table></div> L = <a1 style='color: #FF0000'> "+arcoLCircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1> <br> ou <br>  L = <a1 style='color: #FF0000'> "+arcoLCircular1+" π </a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1> <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  /** ***********************************************   Corda (C = 2.R.sen(α/2))   ***********************  **/  
   ...
   var cordaCircular3 = document.getElementById("resposta").value = roundNumber(cordaCircular3, 2);	  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 20px;'>O comprimento da corda AB é: <br> AB = 2 ∙ R ∙ sen(α/2) <br> AB = 2 ∙ "+raio_maior+" ∙ sen("+anguloα+"°/2) <br> AB = "+cordaCircular1+" ∙ sen("+cordaCircular2+"°) <br> AB = "+cordaCircular1+" ∙ "+cordaCircular3+" <br> AB = <a1 style='color: #FF0000'> "+cordaCircular+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>  </div><hr><h1 class='logomarca'> BpW </h1>"
  ...
  function hexagono1() {
   ...
   var perimetrohexagono = document.getElementById("resposta").value = roundNumber(perimetrohexagono, 2);	  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>O perímetro do hexágono regular é: <br> P = 6 ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp; =&nbsp;  6 ∙ "+ladoa+"    <br> A = <a1 style='color: #FF0000'> "+perimetrohexagono+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ******************************************  perimetro (P = B + b + c + d)  ************************************************/  
   ...
   var Perimetro = document.getElementById("resposta").value = roundNumber(Perimetro, 2);  
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O perímetro do trapézio é: <br> P = B + <a1 style='font-family: times new roman; font-style:italic;'>b</a1> + <a1 style='font-family: times new roman; font-style:italic;'>c</a1> + <a1 style='font-family: times new roman; font-style:italic;'>d</a1>  <br>  P = "+basemaior+" + "+basemenor+" + "+ladoc+" + "+ladod+" <br>  P = <a1 style='color: #FF0000'> "+Perimetro+"&nbsp;</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /** *****************************************  ângulo (α = 180° - δ)  *******************************************/  
   ...
   var anguloα = document.getElementById("resposta").value = roundNumber(anguloα, 2);  
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo α é: <br> α = 180° − δ <br>  α = 180° − "+anguloδ+"° <br>  α =  <a1 style='color: #FF0000'> "+anguloα+"</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>° </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /** *******************************************  ângulo (δ = 180° - α)  *******************************************/  
   ...
   var anguloδ = document.getElementById("resposta").value = roundNumber(anguloδ, 2);   
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo δ é: <br> δ = 180° − α <br>  δ = 180° − "+anguloα+"° <br>  δ =  <a1 style='color: #FF0000'> "+anguloδ+"</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>° </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /** **********************************************  ângulo (β = 180° - γ)  *******************************************/  
   ...
   var anguloy = document.getElementById("resposta").value = roundNumber(anguloy, 2);    
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo γ é: <br> γ = 180° − β <br>  γ = 180° − "+anguloβ+"° <br>  γ =  <a1 style='color: #FF0000'> "+anguloy+"</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>° </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /** **********************************************  ângulo (γ = 180° - β)  *******************************************/  
   ...
   var anguloβ = document.getElementById("resposta").value = roundNumber(anguloβ, 2);    
	 ...
	 document.getElementById('resposta').innerHTML = "<hr><div style='line-height: 20px;'>O ângulo β é: <br> β = 180° − γ <br>  β = 180° − "+anguloy+"° <br>  β =  <a1 style='color: #FF0000'> "+anguloβ+"</a1><a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>° </a1>  </div><hr><h1 class='logomarca'> BpW </h1> ";
  ...
  function paralelepipedo1() {
   ...
   var Volumeparalelepipedo = document.getElementById("resposta").value = roundNumber(Volumeparalelepipedo, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 22px;'>O volume do paralelepípedo é: <br> V = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>b</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>c</a1>  <br>   V =  "+comprimentoa+" ∙ "+largurab+" ∙ "+alturac+" <br> V =  <a1 style='color: #FF0000'> "+Volumeparalelepipedo+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var Volumeparalelepipedo = document.getElementById("resposta").value = roundNumber(Volumeparalelepipedo, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área total do paralelepípedo é: <br> A = 2 ∙(<a1 style='font-family: times new roman; font-style:italic;'>a∙b</a1> + <a1 style='font-family: times new roman; font-style:italic;'>a∙c</a1> + <a1 style='font-family: times new roman; font-style:italic;'>b∙c</a1>)  <br>   A = 2∙("+comprimentoa+"∙"+largurab+"  +  "+comprimentoa+"∙"+alturac+"  + "+largurab+"∙"+alturac+")  <br> A =   <a1 style='color: #FF0000'> "+Volumeparalelepipedo+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var diagonalparalelepipedo4 = document.getElementById("resposta").value = roundNumber(diagonalparalelepipedo4, 2); 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A diagonal do paralelepípedo é: <br><div style='line-height: 24px;'> D =  √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'><a1 style='font-family: times new roman; font-style:italic;'>a</a1>² + <a1 style='font-family: times new roman; font-style:italic;'>b</a1>² + <a1 style='font-family: times new roman; font-style:italic;'>c</a1>²</a1>  <br> D = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>("+comprimentoa+")² + ("+largurab+")² + ("+alturac+")²</a1>  <br>  D = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+diagonalparalelepipedo1+" + "+diagonalparalelepipedo2+" + "+diagonalparalelepipedo3+"</a1>  <br>  D = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+diagonalparalelepipedo4+" </a1>  <br>  D =   <a1 style='color: #FF0000'> "+diagonalparalelepipedo+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var areabase = document.getElementById("resposta").value = roundNumber(areabase, 2);	 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área da base é: <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>b</a1> <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = "+comprimentoa+" ∙ "+largurab+"  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1>  =  <a1 style='color: #FF0000'> "+areabase+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  function cubo1() {
   ...
   var volume = document.getElementById("resposta").value = roundNumber(volume, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 22px;'>O volume do cubo é: <Br>  V = <a1 style='font-family: times new roman; font-style:italic;'>a</a1>³ = ("+arestaa+")³ <br>  V = <a1 style='color: #FF0000'> "+volume+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>      </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var areatotal2 = document.getElementById("resposta").value = roundNumber(areatotal2, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área total do cubo é: <Br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = 6 ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1>² = 6 ∙ ("+arestaa +")² <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> =  6 ∙ "+areatotal2+" <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = <a1 style='color: #FF0000'> "+areatotal+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>   </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var diagonalcubo = document.getElementById("resposta").value = roundNumber(diagonalcubo, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A diagonal D do cubo é: <Br>  D = <a1 style='font-family: times new roman; font-style:italic;'>a</a1> ∙ √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> &nbsp; = &nbsp;"+arestaa+" ∙ 1,73  <br>  D = <a1 style='color: #FF0000'> "+diagonalcubo+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1> <br> ou <br> D = <a1 style='color: #FF0000'> "+arestaa+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1></a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>   </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ****************************** Aresta a em função do volume: (a = √V )  *****************************  **/  
   ...
   var aresta1 = document.getElementById("resposta").value = roundNumber(aresta1, 3);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A aresta <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do cubo é: <Br> <div style='line-height: 22px;'>  V = <a1 style='font-family: times new roman; font-style:italic;'>a</a1>³ <br>  "+volume+" = <a1 style='font-family: times new roman; font-style:italic;'>a</a1>³ <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1>  = ³√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+volume+"</a1>  <br> <a1 style='font-family: times new roman; font-style:italic;'>a</a1>  =  <a1 style='color: #FF0000'> "+aresta1+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>   </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ****************************** Aresta a em função da área: (a = √(V/6) )  *****************************  **/  
   ...
   var aresta3 = document.getElementById("resposta").value = roundNumber(aresta3, 2);    
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> A aresta <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do cubo é: <Br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = 6 ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1>²   <br> "+area+" = 6 ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1>² <br> <div style='line-height: 15px;'>  <table id='fracao'><tbody style='text-align:center;'><tr><td style='border-bottom:solid 1.3px'> "+area+"  </td><td rowspan='2'> &nbsp;=&nbsp; <a1 style='font-family: times new roman; font-style:italic;'>a</a1>² </td></tr><tr><td> 6 </td> </tr></tbody></table> </div> "+aresta3+" = <a1 style='font-family: times new roman; font-style:italic;'>a</a1>² <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = √<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>"+aresta3+"</a1> <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'> "+aresta2+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1>  <hr><h1 class='logomarca'> BpW </h1>  " 
  ...
  /** ****************************** Aresta a em função da Diagonal D: (a = (√3.D)/3) )  *****************************  **/  
   ...
   var aresta5 = document.getElementById("resposta").value = roundNumber(aresta5, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A aresta <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do cubo é: <Br><div style='line-height: 15px;'> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'><a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'>√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1> ∙ D </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'> 1,73 ∙ "+Diagonald+" </td></tr> <tr> <td> 3</td><td> 3 </td> </tr></tbody></table>  <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'>  "+aresta4+" </td></tr><tr><td style='text-align:center;'> 3 </td></tr></tbody></table> </div> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp; = &nbsp; <a1 style='color: #FF0000'> "+aresta3+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman; font-style:italic;'>u</a1> <br>     ou <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=  <a1 style='color: #FF0000'> "+aresta5+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>3</a1></a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman; font-style:italic;'>u</a1>  <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  /** ****************************** Aresta a em função da Diagonal d: (a = (√2.d)/2) )  *****************************  **/  
   ...
   var aresta5 = document.getElementById("resposta").value = roundNumber(aresta5, 2);   
	 ...
	 document.getElementById('resposta').innerHTML =" <hr> A aresta <a1 style='font-family: times new roman; font-style:italic;'>a</a1> do cubo é: <Br> <div style='line-height: 15px;'> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'><a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'>√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>2</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>d</a1> </td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'>1,41 ∙ "+Diagonald1+"</td></tr> <tr> <td>2</td><td>2</td> </tr></tbody></table>  <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'>  "+aresta4+" </td></tr><tr><td style='text-align:center;'> 2 </td></tr></tbody></table>  </div> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'> "+aresta3+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman; font-style:italic;'>u</a1> <br>  ou <br>  <a1 style='font-family: times new roman; font-style:italic;'>a</a1> &nbsp;=  <a1 style='color: #FF0000'> "+aresta5+"√<a1 style='width:100%; height:100%; border-top:solid 1.1px;'>2</a1></a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman; font-style:italic;'>u</a1> <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  function prisma1() {
   ...
   var Res4 = document.getElementById("resposta").value = roundNumber(Res4, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 16px;'>A área da base do prisma regular reto de <a1 style='color: #FF0000'>"+ladosn+"</a1> lados é: <br> <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> <a1 style='font-family: times new roman; font-style:italic;'>n</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>a</a1><a1 style='font-size: 21px; font-family: times new roman;'>²</a1> ∙ cotg(180°/<a1 style='font-family: times new roman; font-style:italic;'>n</a1>) </td></tr><tr><td style='text-align:center;'> 4 </td></tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> "+ladosn+" ∙ ("+ladoa+")<a1 style='font-size: 21px; font-family: times new roman;'>²</a1> ∙ cotg(180°/"+ladosn+") </td></tr><tr><td style='text-align:center;'> 4 </td></tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> "+ladosn+" ∙ "+Res3+" ∙ cotg("+Res4+")° </td></tr><tr><td style='text-align:center;'> 4 </td></tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'>"+Res1+" ∙ "+Res2+" </td></tr><tr><td style='text-align:center;'> 4 </td></tr></tbody></table> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='color: #FF0000'> "+areadabaseprisma+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  </div><hr><h1 class='logomarca'> BpW </h1>"   
  ...
  /** *******************************************   Volume Prisma irregular (At = A(base) . h)    ***********************  **/  
   ...
   var Prismairregularvolume = document.getElementById("resposta").value = roundNumber(Prismairregularvolume, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>O volume do prisma irregular reto é: <br> V = A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> <br>  V = "+areabase+" ∙ "+altura+" <br>  V =  <a1 style='color: #FF0000'> "+Prismairregularvolume+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>      </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  function cilindro1() {
   ...
   var arealateralcilindro2 = document.getElementById("resposta").value = roundNumber(arealateralcilindro2, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 22px;'>A área lateral do cilindro é: <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = 2 ∙ π ∙ R ∙ h  <br>    A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = 2 ∙ 3,14 ∙ "+raioR+" ∙ "+altura+"  <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+arealateralcilindro+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>   <br> ou <br>      A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+arealateralcilindro2+" π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>     </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var areabasecilindro2 = document.getElementById("resposta").value = roundNumber(areabasecilindro2, 2);    
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área da base do cilindro é: <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> =  π ∙ R²  <br>    A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = 3,14 ∙ ("+raioR+")² <br>      A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = 3,14 ∙ "+areabasecilindro2+" <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='color: #FF0000'> "+areabasecilindro+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>   <br> ou <br>      A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='color: #FF0000'> "+areabasecilindro2+" π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>     </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var areabasecilindro3 = document.getElementById("resposta").value = roundNumber(areabasecilindro3, 2);    
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>   A área lateral do cilindro é: <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = 2 ∙ π ∙ R ∙ h  <br>    A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = 2 ∙ 3,14 ∙ "+raioR+" ∙ "+altura+"  <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+arealateralcilindro+"</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br> ou <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+arealateralcilindro2+" π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br> <br>  A área da base do cilindro é: <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> =  π ∙ R²  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = 3,14 ∙ ("+raioR+")² <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = 3,14 ∙ "+areabasecilindro2+" <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='color: #FF0000'> "+areabasecilindro+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br>  ou <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = <a1 style='color: #FF0000'> "+areabasecilindro2+" π</a1>" +"&nbsp; <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br><br> Assim, a área total é:  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = A<a1 style='font-size: 10px; font-family: times new roman;'>(lateral)</a1> + 2 ∙ A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = "+arealateralcilindro+" + 2 ∙ "+areabasecilindro+" <br>    A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = "+arealateralcilindro+" + "+areabasecilindro3+"  <br>                 A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+areatotalcilindro+" </a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br> ou <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+areatotalcilindro2+" π </a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> </div><hr><h1 class='logomarca'> BpW </h1> " 
   ...
   var areatotalcilindro3 = document.getElementById("resposta").value = roundNumber(areatotalcilindro3, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'> A área total do cilindro é: <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = 2 ∙ π ∙ R ∙ (<a1 style='font-family: times new roman; font-style:italic;'>h</a1> + R) <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = 2 ∙ 3,14 ∙ "+raioR+" ∙ ("+altura+" + "+raioR+") <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = 2 ∙ 3,14 ∙ "+raioR+" ∙ "+areatotalcilindro2+"  <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+areatotalcilindro+" </a1>" +"<a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br> ou <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+areatotalcilindro3+" π </a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> </div><hr><h1 class='logomarca'> BpW </h1>" 
   ...
   var volumecilindro3 = document.getElementById("resposta").value = roundNumber(volumecilindro3, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'> O volume do cilindro reto é: <br> V = A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1>  ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1>  <br> V = π ∙ R² ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> <br> V = 3,14 ∙ ("+raioR+")² ∙ "+altura+" <br>   V = 3,14 ∙ "+volumecilindro2+" ∙ "+altura+"   <br>  V = <a1 style='color: #FF0000'> "+volumecilindro+"</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1> <br> ou  <br> V = <a1 style='color: #FF0000'> "+volumecilindro3+" π </a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>      </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /*********************************************     Raio R: (R = (V/√(π.h) ****************************************  **/  
   ...
   var resul3 = document.getElementById("resposta").value = roundNumber(resul3, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  O Raio R do cilindro é: <br>  V = A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1>  <br> V = π ∙ R² ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> <br> "+volume+" = 3,14 ∙ R² ∙ "+altura+" <br> "+volume+" = "+resul2+" ∙ R² <br> <div style='line-height: 14px;'>    <table id='fracao'><tbody style='text-align:center;'><tr><td style='border-bottom:solid 1.3px'> "+volume+" </td><td rowspan='2'> &nbsp;=&nbsp; R<span class=\'exp\'>2</span> </td></tr><tr><td> "+resul2+" </td> </tr></tbody></table></div> "+resul3+" = R² <br>   R = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>"+resul3+"</a1> <br>  R = <a1 style='color: #FF0000'> "+raioRcilindro+"</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <hr><h1 class='logomarca'> BpW </h1>  " 
  ...
  /******************************   Area lateral - cilindro oco (AL = 2.π.h(r1 + r2)    ********************************  **/  
   ...
   var cilindroocoarealateral3 = document.getElementById("resposta").value = roundNumber(cilindroocoarealateral3, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A área lateral do cilindro oco é: <br> <div style='line-height: 22px;'> A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1>  = 2 ∙ π ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> ∙ (<a1 style='font-family: times new roman; font-size: 20px; font-style:italic;'>r</a1><a1 style='font-size: 10px; font-family: times new roman;'>1</a1> + <a1 style='font-family: times new roman;font-size: 20px; font-style:italic;'>r</a1><a1 style='font-size: 10px; font-family: times new roman;'>2</a1>) <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1>  = 2 ∙ 3,14 ∙ "+altura+" ∙ ("+raio1+" + "+raio2+") <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1>  = 2 ∙ 3,14 ∙ "+altura+" ∙ "+cilindroocoarealateral2+"  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+cilindroocoarealateral+"</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br>  ou <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Lateral)</a1> = <a1 style='color: #FF0000'> "+cilindroocoarealateral3+" π</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>      </div><hr> <h1 class='logomarca'> BpW </h1> " 
  ...
  /**********************************   Volume - cilindro oco (V = π.h.(r1² - r2²)   ****************************************  **/  
   ...
   var cilindroocoareatotal2 = document.getElementById("resposta").value = roundNumber(cilindroocoareatotal2, 2);   
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'> O Volume do cilindro oco é: <br> V = π ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> ∙ (<a1 style='font-family: times new roman; font-size: 20px; font-style:italic;'>r</a1><a1 style='font-size: 10px; font-family: times new roman;'>1</a1>² - <a1 style='font-family: times new roman;font-size: 20px; font-style:italic;'>r</a1><a1 style='font-size: 10px; font-family: times new roman;'>2</a1>²)         <br>  V = 3,14 ∙ "+altura+" ∙ ("+raio1+"² - "+raio2+"²) <br>  V = "+Resul2+" ∙ ("+Resul3+" - "+Resul4+") <br>  V = "+Resul2+" ∙ "+Resul5+"  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+cilindroocoareatotal+"</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> <br> ou  <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(Total)</a1> = <a1 style='color: #FF0000'> "+cilindroocoareatotal2+" π</a1>" +" <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>   </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** *****************************************************   Área da base (Ab = π.R²)   ****************************************  **/  
   ...
   var Resul2 = document.getElementById("resposta").value = roundNumber(Resul2, 2);  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área da base do cone é: <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = π ∙ R² <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1>  = 3,14 ∙ ("+raioR+")² <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(base)</a1> = 3,14 ∙ "+Resul2+" <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(Base)</a1> = <a1 style='color: #FF0000'> "+areabasecone+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  if (a === "apotemabasepiramide") { 
   ...
   var Resul4 = document.getElementById("resposta").value = roundNumber(Resul4, 2);	  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr>  A apótema <a1 style='font-family: times new roman; font-style:italic;'>r</a1> da base da pirâmide é: <br> <div style='line-height: 15px;'> <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> <a1 style='font-family: times new roman; font-style:italic;'>r</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> <a1 style='font-family: times new roman; font-style:italic;'>a</a1> </td></tr><tr><td style='text-align:center;'> <a1 style='font-family: times new roman;'> 2 ∙ tg(180°/<a1 style='font-family: times new roman; font-style:italic;'><a1 style='font-family: times new roman; font-style:italic;'>n</a1></a1>) </td></tr></tbody></table>  <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> <a1 style='font-family: times new roman; font-style:italic;'>r</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> "+arestabasea +" </td></tr><tr><td style='text-align:center;'> <a1 style='font-family: times new roman;'> 2 ∙ tg(180°/"+ladosn+") </td></tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr><td  rowspan='2'> <a1 style='font-family: times new roman; font-style:italic;'>r</a1> &nbsp;=&nbsp; </td><td style='border-bottom:solid 1.3px;text-align:center;'> "+arestabasea+" </td></tr><tr><td style='text-align:center;'> <a1 style='font-family: times new roman;'> 2 ∙ tg("+Resul2+"°) </td></tr></tbody></table>  <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'><a1 style='font-family: times new roman; font-style:italic;'>r</a1> &nbsp;=&nbsp; </td>  <td style='border-bottom:solid 1.3px'>"+arestabasea+"</td>  <td rowspan='2'> &nbsp;=&nbsp; </td> <td style='border-bottom:solid 1.3px'>"+arestabasea+"</td></tr> <tr> <td>2 ∙ "+Resul3+"</td><td>"+Resul4+"</td> </tr></tbody></table> </div>  <a1 style='font-family: times new roman; font-style:italic;'>r</a1> = <a1 style='color: #FF0000'> "+apotemabasepiramide+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u</a1> <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  /** ****************************************    Superficie da esfera: S = 4.π.r²  ****************************************  **/  
   ...
   var superifice2 = document.getElementById("resposta").value = roundNumber(superifice2, 2);	 
	   ...
	   document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área da superfície S da esferá é: <br> S = 4 ∙ π ∙ R² <br> S = 4 ∙ 3,14 ∙ ("+raioR+")² <br>   S = 4 ∙ 3,14 ∙ "+Resul2+" <br>  S = <a1 style='color: #FF0000'> "+superifice+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br> ou <br>  S = <a1 style='color: #FF0000'> "+superifice2+"π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>          </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ****************************   ÁRea da superficíe da Semiesfera: S = 2.π.h.r    **********************************  **/  
   ...
   var superifice2 = document.getElementById("resposta").value = roundNumber(superifice2, 2);	
	   ...
	   document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 20px;'>A área da superfície da semiesfera parcial é: <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(superfície)</a1> = 2 ∙ π ∙ <a1 style='font-family: times new roman; font-style:italic;'>h</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>r</a1>  <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(superfície)</a1> = 2 ∙ 3,14 ∙ "+alturah+" ∙ "+raior+"  <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(superfície)</a1> = <a1 style='color: #FF0000'> "+superifice+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>  <br> ou <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(superfície)</a1> = <a1 style='color: #FF0000'> "+superifice2+"π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u³</a1>          </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** *****************************************   Área total da Semiesfera: S = 2.π.h.r + π(2r² - h²)    ****************************************  **/  
   ...
   var superifice2 = document.getElementById("resposta").value = roundNumber(superifice2, 2);	 
	   ...
	   document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área total da superfície da semiesfera parcial é: <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = 2∙π∙<a1 style='font-family: times new roman; font-style:italic;'>h</a1> ∙ <a1 style='font-family: times new roman; font-style:italic;'>r</a1>  +  π∙(2∙<a1 style='font-family: times new roman; font-style:italic;'>r</a1>² − <a1 style='font-family: times new roman; font-style:italic;'>h</a1>²) <br>   A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = 2∙3,14∙"+alturah+"∙"+raior+" + 3,14∙ [2∙("+raior+")² − ("+alturah+")²]<br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = "+resul1+" + 3,14 ∙ [2∙("+resul2+") − "+resul3+"] <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = "+resul1+" + 3,14 ∙ ("+resul4+" − "+resul3+") <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = "+resul1+" + 3,14 ∙ "+resul5+"  <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = "+resul1+" + "+resul6+"  <br> A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = <a1 style='color: #FF0000'> "+superifice+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br> ou <br>  A<a1 style='font-size: 10px; font-family: times new roman;'>(total)</a1> = <a1 style='color: #FF0000'> "+superifice2+"π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1> </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  /** ********************    Área do circulo de raio c da Semiesfera: A = π.(r² - h²)    ****************************************  **/  
   ...
   var arearaioc2 = document.getElementById("resposta").value = roundNumber(arearaioc2, 2); 
	   ...
	   document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 22px;'>A área do círculo de raio c da semiesfera parcial é: <br> A = π(<a1 style='font-family: times new roman; font-style:italic;'>r</a1>² − <a1 style='font-family: times new roman; font-style:italic;'>h</a1>²)  <br> A = 3,14 ∙ [("+raior+")² − ("+alturah+")²]  <br>  A = 3,14 ∙ ["+resul2+" - "+resul3+"] <br> A = 3,14 ∙ "+resul4+" <br>  A = <a1 style='color: #FF0000'> "+arearaioc+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <br> ou <br>   A = <a1 style='color: #FF0000'> "+arearaioc2+"π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>        </div><hr><h1 class='logomarca'> BpW </h1>" 
  ...
  function contagem1() {
   ...
   var elementosn = document.getElementById("resposta").value = roundNumber(elementosn, 0);	 
	  ...
	  for(x = 1; x <= elementosn; x++)
		...
		document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 25px;'> O valor do fatorial <a1 style='color: #FF0000'>"+elementosn.toFixed(0)+"</a1>! é: <br> "+resultado+" </div>  <hr><h1 class='logomarca'> BpW </h1> " 
  ...
  /** ******************************   Primeiro termo a_1: (a_1 = a_n - (n - 1).r)   *****************************  **/  
   ...
   var result3 = document.getElementById("resposta").value = roundNumber(result3, 2);  
	 ...
	 document.getElementById('resposta').innerHTML =" <hr><div style='line-height: 22px;'> O primeiro termo <a1 style='color: #FF0000'><a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 10px; font-family: times new roman;'>1</a1></a1> da P.A. finita é: <br> <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman; '>n</a1> = <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman; '>1</a1> + (<a1 style='font-family: times new roman;font-size: 20px; font-style:italic;'>n</a1> - 1) ∙ <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>r</a1> <br> <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman; '>1</a1> = <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman; '>n</a1> - (<a1 style='font-family: times new roman;font-size: 20px; font-style:italic;'>n</a1> - 1) ∙ <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>r</a1>  <br>  <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman;'>1</a1> =  "+a_n+" - ("+n+" - 1) ∙ ("+razaor+")  <br> <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman;'>1</a1> =  "+a_n+" - "+result2+" ∙ ("+razaor+")  <br> <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman;'>1</a1> =  "+a_n+" - ("+result3+")  <br>    <a1 style='font-family: times new roman;font-size: 23px; font-style:italic;'>a</a1><a1 style='font-size: 11px; font-family: times new roman;'>1</a1> =<a1 style='color: #FF0000'> "+a_1+"</a1>  <hr>  <h1 class='logomarca'> BpW </h1>  </div>" 
  ...
  try {
	  ...
	  var resul = document.getElementById("resposta").value = roundNumber(resul, 2);		
			...
			document.getElementById('resposta').innerHTML = " <hr>  <div style='font-size:18px;'>  &emsp;   <a1 style='color: #FF0000'>"+coef_a+"</a1>x² + (<a1 style='color: #FF0000'>"+coef_b+"</a1>)x + (<a1 style='color: #FF0000'>"+coef_c+"</a1>) = 0  </div>   <br> O valor numérico da função quadrática é: <br><br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>f</a1>(<a1 style='font-family: times new roman; font-size: 12px; font-style:italic;'>x</a1>) = <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>a</a1><a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>x</a1>² + <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>b</a1><a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>x</a1> + <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>c</a1>  <br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>f</a1>(<a1 style='font-family: times new roman; font-size: 12px; '>"+variável_x+"</a1>) =  "+coef_a+"∙("+variável_x+")² + ("+coef_b+")∙("+variável_x+") + ("+coef_c+") <br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>f</a1>(<a1 style='font-family: times new roman; font-size: 12px; '>"+variável_x+"</a1>) =  "+coef_a+" ∙ "+xx+" + ("+bx+") + ("+coef_c+") <br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>f</a1>(<a1 style='font-family: times new roman; font-size: 12px; '>"+variável_x+"</a1>) =  "+axx+" + ("+bx+") + ("+coef_c+") <br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>f</a1>(<a1 style='font-family: times new roman; font-size: 12px; '>"+variável_x+"</a1>) =  <a1 style='color: #FF0000'>"+resul+"</a1> <br>   <hr>  <h1 class='logomarca'> BpW </h1> ";
  ...
  try {
   ...
   var x2 = document.getElementById("resposta").value = roundNumber(x2, 2); 
	   ...
	   if (delta < 0) { 
			document.getElementById('resposta').innerHTML = " <hr>  <div style='font-size:18px;'>  &emsp;   <a1 style='color: #FF0000'>"+coef_a+"</a1>x² + (<a1 style='color: #FF0000'>"+coef_b+"</a1>)x + (<a1 style='color: #FF0000'>"+coef_c+"</a1>) = 0  </div>        <br> Os coeficientes são: <br> <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>a</a1> = "+coef_a+" &emsp; <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>b</a1> =  "+coef_b+" &emsp; <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>c</a1> =  "+coef_c+"  <br><br> Agora, o cálculo do discriminante (delta): <br>   Δ = b² - 4ac <br>  Δ = ("+coef_b+")² - 4 ∙ ("+coef_a+") ∙ ("+coef_c+") <br>  Δ = "+delta1+" - ("+delta2+") <br> Δ = "+delta+" <br> <br> Como Δ = <a1 style='color: #FF0000'>"+delta+"</a1> < 0, logo a equação não possui raiz real. <br>    <hr> <h1 class='logomarca'> BpW </h1> ";
			document.quadratica.coef_a.focus();
			   document.quadratica.coef_a.select(); 
	  return false;		  
		 }
  ...
  try {
   var coef_a = document.getElementById("resposta").value = roundNumber(coef_a, 2);	
	  ...
	  return false;		  
			...
			document.getElementById('resposta').innerHTML = " <hr> Como coeficiente <a1 style='font-family: times new roman; font-size: 16px; font-style:italic;'>a</a1> = <a1 style='color: #FF0000'>"+coef_a+" < 0</a1>. Logo, a função tem gráfico com concavidade voltada para baixo. <br> <br>  <style>#box1{width:150px; height:80px; background-color:#d9d9d9; border-radius: 90px 90px 0px 0px;border: 2px solid #ff0000; border-bottom-color: #d9d9d9; margin-left: 90px;} </style><div id='box1'></div>   <hr>   <h1 class='logomarca'> BpW </h1> ";
  ...
  function Geom_Analit1() {
   ...
   var eq_ret5 = document.getElementById("resposta").value = roundNumber(eq_ret5, 2);	  
	  ...
	  document.getElementById('resposta').innerHTML ="<hr> <div style='line-height: 20px; padding: 5px; '>A equação geral da reta é: <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> - <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1><a1 style='font-size: 10px; font-family: times new roman;'>A</a1> = <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>m</a1> ∙ (<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> - <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1><a1 style='font-size: 10px; font-family: times new roman;'>A</a1>) <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> - ("+y_a+") = "+coefangular_m+" ∙ (<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> - ("+x_a+")) <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> + ("+eq_ret+") = "+coefangular_m+" ∙ (<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> + ("+eq_ret1+")) <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> + ("+eq_ret+") = "+coefangular_m+"<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> + ("+eq_ret2+") <br>   "+eq_ret3+"<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> + <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> + ("+eq_ret+") + ("+eq_ret4+") = 0 <br>  "+eq_ret3+"<a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>x</a1> + <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>y</a1> + ("+eq_ret5+")  = 0 <br>  <hr>        <h1 class='logomarca'> BpW </h1> </div>" 
   ...
   var tgα= document.getElementById("resposta").value = roundNumber(tgα, 3);	
	  ...
	  document.getElementById('resposta').innerHTML =" <hr> <div style='line-height: 20px; padding: 5px; '>O coeficiente angular é: <br> <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>m</a1> = tg α <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>m</a1> = tg "+angulo_α+"º <br>  <a1 style='font-family: times new roman; font-style:italic;font-size: 20px;'>m</a1> =  <a1 style='color: #FF0000'>"+tgα+"</a1>  <br> <hr>  <h1 class='logomarca'> BpW </h1> </div>" 
	  document.Geom_Analit.angulo_α.focus();
	  document.Geom_Analit.angulo_α.select();     
	  document.getElementById('resposta').style.display = "block";
  }	
  ...
  try {
   ...
   var result4 = document.getElementById("resposta").value = roundNumber(result4, 5);	 
	  ...
	  document.getElementById('resposta').innerHTML = "<hr> O valor do montante (M) é: <br> M = C ∙ (1 + i ∙ t) <br>    M = "+capit+" ∙ (1 + "+result4+" ∙ "+tempo+") <br>  M = "+capit+" ∙ (1 + "+result2+") <br> M = "+capit+" ∙ ("+result3+") <br>   M = "+result1.toFixed(2)+"  <br><br> Logo, o Montante (M) é: <br> M = <a1 style='color: #FF0000'> $ "+result1.toFixed(2)+" </a1>     <hr>  <h1 class='logomarca'> BpW </h1> ";
  ...
  try {
   ...
   var result7 = document.getElementById("resposta").value = roundNumber(result7, 2); 
	  ...
	  document.getElementById('resposta').innerHTML = "<hr> O valor da taxa (i) é: <br>  M = C × (1 + i)<span class=\'exp\'>t</span>  <br>  "+montant+" = "+capit+" × (1 + i)<span class=\'exp\'>"+tempo+" </span> <br> <table id='fracao'><tbody><tr><td style='border-bottom:solid 1px'> "+montant+" </td><td rowspan='2'> &nbsp;=&nbsp; (1 + i)<span class=\'exp\'>"+tempo+" </span> </td></tr><tr><td> "+capit+" </td> </tr></tbody></table>   "+result3+" = (1 + i)<span class=\'exp\'>"+tempo+" </span> <br><br>  <span class=\'exp\'>"+tempo+"</span>√<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px;'>"+result3+"</a1> &nbsp;=&nbsp;   <span class=\'exp\'>"+tempo+"</span>√<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.1px;'>(1 + i)<span class=\'exp\'>"+tempo+" </span></a1>  <br>  "+result5+" = 1 + i <br>   "+result5+" - 1 =  i <br>    "+result6+" =  i <br>    i =  "+result6+" <br> ou  <br>  i =  "+result6+" × 100 = "+result7+"% <br><br>     Logo, a taxa (i) é: <br> i = <a1 style='color: #FF0000'>"+result7+"%</a1>   <hr><h1 class='logomarca'> BpW </h1> ";
  ...
  try {
   ...
   var result2 = document.getElementById("resposta").value = roundNumber(result2, 5);	
	  ...
	  document.getElementById('resposta').innerHTML = " <hr> Quanto é <a1 style='color: #FF0000'>"+taxa+"%</a1> de <a1 style='color: #FF0000'>"+valor1+"</a1>? <br><br>  Observe que: "+taxa+" ÷ 100 = "+result1+" <br> Logo, <br>&emsp;  "+valor1+" × "+result1+" = "+result2+" <br>   Portanto, o valor é: <br> &emsp;  <a1 style='color: #FF0000'> "+result2+"</a1>   <hr><h1 class='logomarca'> BpW </h1> ";
  ...
  try {
   ...
   var result3 = document.getElementById("resposta").value = roundNumber(result3, 6);  
	  ...
	  document.getElementById('resposta').innerHTML = "<hr>Tenho <a1 style='color: #FF0000'>"+valor1+"</a1> e quero descontar <a1 style='color: #FF0000'>"+taxa+"%</a1>. Qual é o resultado? <br> Observe que:<br>&emsp; 100% − "+taxa+"% = "+result1+"% <br> Logo, <br> &emsp; "+result1+"% ÷ 100 = "+result2+" <br>  Portanto, basta multiplicar por: "+result2+" <br>     Logo,<br>&emsp;  "+valor1+" × "+result2+" =  "+result3+" <br> Portanto, o valor é: <br>&emsp;    <a1 style='color: #FF0000'> "+result3+" </a1>  <hr> <h1 class='logomarca'> BpW </h1> ";
  ...
  try {
   ...
   var result3 = document.getElementById("resposta").value = roundNumber(result3, 6); 
	   ...
	   document.getElementById('resposta').innerHTML = "<hr>Tenho <a1 style='color: #FF0000'>"+valor1+"</a1> e diminuiu para <a1 style='color: #FF0000'>"+valor2+"</a1>. Qual foi a diminuição percentual? <br> Observe que:<br>&emsp; "+valor1+" − "+valor2+" = "+result1+" <br> Como <br> &emsp; "+result1+" ÷ "+valor1+" = "+result2+" <br> Portanto, basta multiplicar por 100: <br> &emsp; "+result2+" × 100 = "+result3+" <br> Portanto, o valor é: <br>&emsp; <a1 style='color: #FF0000'> "+result3+"% </a1>  <hr><h1 class='logomarca'> BpW </h1> ";
  ...
  /************************  Cálculdo da área: A = (B.b).h/2  *************************/  
   ...
   var areaElipse = Math.PI * semieixo_maior * semieixo_menor;
	 ...
	 document.getElementById('resposta').innerHTML ="  <hr> <div style='line-height: 16px;'>A área da Elipse é: <br> Área = π ∙ a ∙ b <br>  Área = π ∙ "+semieixo_maior+" ∙ "+semieixo_menor+" <br> Área = <a1 style='color: #FF0000'> "+areaElipse.toFixed(2)+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u²</a1>  <hr><h1 class='logomarca'> BpW </h1></div>" 
   ...
   var Peri_Elipse = 2 * Math.PI * k; 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr><div style='line-height: 16px;'>O perímetro da Elipse é: <br><br>  P = 2π √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>(a² + b²)/2</a1> <br><br>  P = 2π √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>[("+semieixo_maior+")² + ("+semieixo_menor+")²]/2</a1> <br><br>  P = 2π √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>["+aa+" + "+bb+"]/2</a1> <br><br> P = 2π √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>"+soma_ab+"/2</a1> <br><br>  P = 2π √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>"+h.toFixed(2)+"</a1> <br>  P ≈ 2π ∙ "+k.toFixed(2)+" <br>  P ≈ <a1 style='color: #FF0000'> "+y.toFixed(2)+"π</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u.m</a1> <br> &emsp;ou <br> P ≈ <a1 style='color: #FF0000'> "+Peri_Elipse.toFixed(2)+"</a1>" +"&nbsp <a1 style='font-size: 16px; font-family: times new roman;font-style:italic;'>u.m</a1>  <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
  }	
  ...
  /** ******************   Equação: (x - xo)²/a² + (y - yo)²/b² = 1)  *********************/  
   ...
   if ((x_o < 0) && (y_o < 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - ("+x_o+"))² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - ("+y_o+"))² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x + "+k+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y + "+h+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o < 0) && (y_o > 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - ("+x_o+"))² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>    <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x + "+k+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o > 0) && (y_o < 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - ("+y_o+"))² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>        <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y + "+h+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o > 0) && (y_o == 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> y² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o < 0) && (y_o == 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - ("+x_o+"))² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x + "+k+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> y² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o == 0) && (y_o > 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> x² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
   ...
   if ((x_o == 0) && (y_o < 0)) {
	  document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - ("+y_o+"))² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> x² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y + "+h+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>    <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  return false;		  
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseHorin.png'></div><hr><div style='line-height: 16px;'>Como temos o semieixo maior a = <a1 style='color: #FF0000'> "+semieixo_maior+"</a1>, o semieixo menor b = <a1 style='color: #FF0000'> "+semieixo_menor+"</a1> e as coordenadas do centro = (<a1 style='color: #FF0000'> "+x_o+"</a1>, <a1 style='color: #FF0000'> "+y_o+"</a1>). Logo, a equação da elipse com eixo maior na horizontal é: <br> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - x<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - y<a1 style='font-size: 10px; font-family: times new roman;'>o</a1>)² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> a² </td><td> b² </td> </tr></tbody></table> <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+semieixo_maior+"² </td><td> "+semieixo_menor+"² </td> </tr></tbody></table>   <table id='fracao'><tbody style='text-align:center;'><tr> <td rowspan='2'></td>  <td style='border-bottom:solid 1.3px'> (x - "+x_o+")² </td>  <td rowspan='2'> &nbsp;+&nbsp; </td> <td style='border-bottom:solid 1.3px'> (y - "+y_o+")² </td><td rowspan='2'> &nbsp;=&nbsp;  1 </td></tr> <tr> <td> "+aa+" </td><td> "+bb+" </td> </tr></tbody></table>      <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
	  }
  ...
  /***************** eixo maior na vertical: Semidistância focal (c = √(b² - a²))  *****************/  
   ...
   var bb = document.getElementById("resposta").value = roundNumber(bb, 2); 
	 ...
	 document.getElementById('resposta').innerHTML ="<hr> <div align='center'><img src='https://blogdoprofwarles.com/Cal/elipseVert.png'></div><hr><div style='line-height: 16px;'>O comprimentro da semidistância focal (c) da elipse com eixo maior na vertical é:<br><br>  c = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>("+semieixo_menor+")² - ("+semieixo_maior+")²</a1>  <br><br>  c = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>"+h+" - "+k+"</a1>  <br><br>  c = √<a1 style='width:100%; height:100%; border-top:solid 1.1px; padding:1.2px;'>"+aa+"</a1> <br>  c = <a1 style='color: #FF0000'> "+bb+"</a1> u.c   <hr><h1 class='logomarca'> BpW </h1></div>" 
	  document.Elipse.semieixo_maior.focus();
	  document.Elipse.semieixo_maior.select();     
	  document.getElementById('resposta').style.display = "block";
  }	
